...
describe('ButtonIcon', () => {
  ...
  it('applique le fond de la variante primary', async () => {
    const view = await renderNative(<ButtonIcon variant="primary" icon="Check" />);
  ...
  it('remplace le fond par celui de l etat desactive', async () => {
    const view = await renderNative(<ButtonIcon variant="primary" icon="Check" disabled />);
  ...
  it('applique le rembourrage de la taille lg', async () => {
    const view = await renderNative(<ButtonIcon variant="primary" icon="Check" size="lg" />);
  ...
  it('laisse iconSize primer sur la taille du bouton', async () => {
    const view = await renderNative(<ButtonIcon variant="primary" icon="Check" size="lg" iconSize="md" />);
  ...
  it('laisse la prop style ecraser la variante et la taille', async () => {
    const view = await renderNative(
      <ButtonIcon variant="primary" icon="Check" style={{ backgroundColor: 'red', borderRadius: 0 }} />,
    );
  ...
  it('affiche le nombre lui-meme quand icon est numerique', async () => {
    const { getByText } = await renderNative(<ButtonIcon variant="primary" icon={3} />);
  ...
  it('donne une bordure a la variante secondary', async () => {
    const view = await renderNative(<ButtonIcon variant="secondary" icon="Check" />);
  ...
  it('laisse la variante tertiary sans fond au repos', async () => {
    const view = await renderNative(<ButtonIcon variant="tertiary" icon="Check" />);
