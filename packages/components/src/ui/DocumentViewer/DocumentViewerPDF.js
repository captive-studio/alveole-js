...
const isPdfCancellationError = error => {
...
export const DocumentViewerPDF = props => {
  ...
  const onPdfLoadedSuccess = React.useCallback((documentPdf, active) => {
    ...
    children: _jsx(Box, {
      ...
      children:
        ...
        _jsx(Box, {
          ...
          children: _jsx('canvas', { ref: canvasRef, style: styles.viewerPdfCanvas }),
        }),
    }),
  });
};
