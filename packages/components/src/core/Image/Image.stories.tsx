  ...
  return (
    <Box>
      <Box>
        ...
        <Image source="https://picsum.photos/seed/696/400/300" alt="Photo de démonstration" width={400} height={300} />
      </Box>

      <Box>
        <Typography>Image déformée avec width 250 et height 200 (rendu 250 x 200)</Typography>
        <Image source="https://picsum.photos/seed/696/400/300" alt="Photo de démonstration" width={250} height={200} />
      </Box>

      <Box>
        <Typography>Image avec une width de 200px (rendu 200 x 150)</Typography>
        <Image source="https://picsum.photos/seed/696/400/300" alt="Photo de démonstration" width={200} />
      </Box>

      <Box>
        <Typography>Image avec une height de 200px (rendu 400 x 200)</Typography>
        <Image source="https://picsum.photos/seed/696/400/300" alt="Photo de démonstration" height={200} />
      </Box>
    </Box>
  );
};
...
export const MaxWidth = () => {
  return (
    <Box>
      ...
      <Image source="https://picsum.photos/seed/696/400/300" alt="Photo de démonstration" maxWidth={200} />
    </Box>
  );
};
...
export const MaxHeight = () => {
  return (
    <Box>
      ...
      <Image source="https://picsum.photos/seed/696/400/300" alt="Photo de démonstration" maxHeight={200} />
    </Box>
  );
};
...
export const MaxWidthAndHeight = () => {
  return (
    <Box>
      ...
      <Image
        source="https://picsum.photos/seed/696/400/300"
...
export const ImageNotFound = () => {
  return (
    <Box>
      ...
      <Image source="https://invalid.url" alt="Image dont le chargement échoue" width={200} height={200} />
    </Box>
  );
};
